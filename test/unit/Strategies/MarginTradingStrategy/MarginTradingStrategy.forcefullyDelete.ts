...
export function checkForcefullyDelete(): void {
  it("MarginTradingStrategy: forcefullyDelete", async function () {
    ...
    await this.marginTradingStrategy.connect(this.signers.liquidator).forcefullyDelete(this.vault.address, 1, 10);
  });
}
